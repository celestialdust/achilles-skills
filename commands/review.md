---
description: Review stage quality gate — five-axis code-review with a parallel fan-out to code-simplification, security-and-hardening, and performance-optimization, plus any specialist the diff's facts add. Those four are a floor, not a list. Runs before merge; surfaces findings, never auto-merges.
---
