...
- `browser-testing-with-devtools` uses whatever browser MCP is configured (`chrome-devtools`, `claude-in-chrome`, `playwright`, or `agent-browser`).
...
| `/setup` | project-setup | One-time repo ecosystem: `STATE.md` · `CONTEXT.md` · `docs/adr/` · `docs/features/` · `docs/session-state.md` · `docs/session-log.md` · `docs/progress.md` · `docs/lessons.md` · the `## Agent skills` block in one of `CLAUDE.md` / `AGENTS.md` + a short pointer to it in the other |
