...
| `codebase-research` | **feed the design and the plan** — goal-blind facts about the code as it is, surveyed at the head of Spec and again at the head of Plan | teach or test a human |
