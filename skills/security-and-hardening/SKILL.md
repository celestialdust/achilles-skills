...
**Emits:** `findings` → `docs/features/<slug>/<SLICE-ID>/security-findings.md`. Per-slice; **you are the sole writer** of this file (disjoint from `performance-optimization`'s findings file — the Review fan-out's disjoint-file guard, `parallelism.md` mech e).
