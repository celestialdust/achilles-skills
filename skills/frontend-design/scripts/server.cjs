...
// VENDOR DIFF (telemetry strip): upstream defined SUPERPOWERS_BRAND_IMAGE_URL here
// (a remote primeradiant.com brand-logo beacon — the only outbound network touch)
// and a TELEMETRY_DISABLE_ENV_VARS probe. Both removed so the header is network-free.
// See VENDORED.md for the enumerated diff and audit.
...
<html>
<head><meta charset="utf-8"><title>Frontend Design — Visual Companion</title>
<style>
...
<body><!-- BRANDING --><h1>Frontend Design — Visual Companion</h1>
...
function bootstrapPage(key) {
  ...
  return `<!DOCTYPE html>
<html>
<head><meta charset="utf-8"><title>Opening Frontend Design — Visual Companion</title></head>
<body>
<script>
