...
- Never weaken a frozen `acceptance.md` assertion, a RED test, or the regression surface to make a
  finding tractable — surfacing gate-erosion is your job, not committing it (safety rail 4,
  `references/safety-rails.md`, which covers the read-only `docs/design.md` too).
